...
@Component({
  selector: 'Airplane-home',
  templateUrl: './Airplane-home.component.html',
  styleUrls: ['./Airplane-home.component.scss']
})
export class AirplaneHomeComponent implements AfterViewInit {
