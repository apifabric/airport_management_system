...
def declare_logic():
    ...
    # Calculate number of passengers on an airplane
    Rule.count(derive=Airplane.passenger_count, as_count_of=Passenger)

    # Ensure airplanes do not exceed their passenger capacity
